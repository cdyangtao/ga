        ...
        <div class="modal-body">
          ...
          <div class="col-lg-12">
              <div class="widget-container fluid-height clearfix">
                <div class="heading">
                  <i class="icon-reorder"></i>Select Ad settings
                </div>
                <div class="widget-content padded">
                  <form action="<?php echo U('add','',false);?>" method="POST" class="form-horizontal">
                    <div class="form-group">
                      <label class="control-label col-md-3">Final URL</label>
                      <div class="col-md-7">
                    ...
                    <div class="form-group">
                      ...
                      <label class="control-label col-md-1">/</label><div class="col-md-2"><input class="form-control" placeholder="path1" type="text" name="campaignName" /></div><label class="control-label col-md-1">/</label><div class="col-md-2"><input class="form-control" placeholder="path2" type="text" name="campaignName" /></div>
                    </div>
...
$(function(){
  ...
  $("#keyword_status").on("change",function(){
    ...
    if(ids.length>0){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo U('/adGroup/updateKeyword','',false);?>",
        data: 'ids='+ids_str+'&adGroupId=<?php echo $adGroupId;?>',
        cache:false,
        dataType:'json',
